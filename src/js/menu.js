...
const menu = () => {
  ...
  divContentMenu.classList.add('d-flex', 'justify-content-center', 'align-items-center', 'flex-wrap');
  container.appendChild(divContentMenu);

  //conatiner will reapet
  ...
  cardTitle.innerHTML = 'title here';
  cardBody.appendChild(cardTitle); //addtitle

  const cardText = document.createElement('p');
  cardText.classList.add('card-text');
  cardText.innerHTML = "here is the Text";
